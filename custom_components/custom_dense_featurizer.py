...
class CountVectorsFeaturizer(SparseFeaturizer):
    ...
    def train(
        ...
        '''
        {'text': [['привет', 'привет'], ['здравствуйте', 'здравствуйте'], ['до', 'свидания'], ['пока', 'пока'], 
        ['да', 'да'], ['конечно', 'конечно'], ['нет', 'нет'], ['не', 'хочу'], ['круто', 'круто'], 
        ['все', 'хорошо'], ['мой', 'день', 'был', 'ужасный'], ['я', 'опечален'], ['ты', 'бот'], ['ты', 'человек'], 
        ['я', 'говорю', 'с', 'ботом'], ['я', 'говорю', 'с', 'человеком']], 
        'intent': [['greet'], ['greet'], ['goodbye'], ['goodbye'], ['affirm'], ['affirm'], ['deny'], ['deny'], 
        ['mood_great'], ['mood_great'], ['mood_unhappy'], ['mood_unhappy'], ['bot_challenge'], ['bot_challenge'], 
